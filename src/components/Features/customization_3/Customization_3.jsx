...
import '../customization_1/Customization_1.scss'
    ...
    <section className="customization">
      <div className="customization__container container">
        ...
        <div className="customization__image">
          <picture>
            <source media="(max-width: 375px)" srcSet="/375px/cust-3.svg" />
            <source media="(max-width: 1024px)" srcSet="/1024px/cust-3.svg" />
            <img 
              src="/1920px/cust-3.svg" 
              alt="Customization" 
